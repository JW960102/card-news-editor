...
// ① 설정 — [장수 · 스타일 · 레이아웃 타입] 정하면 뼈대 생성. + 저장한 작업 불러오기.
  ...
  return (
    <div style={{ minHeight: '100%', background: '#f4f4f5', padding: 40, ...ui }}>
      <div style={{ maxWidth: 520 }}>
        <h1 style={{ fontSize: 26, fontWeight: 600, marginBottom: 6 }}>카드뉴스 뼈대 만들기</h1>
        <p style={{ color: '#666', marginBottom: 32, fontSize: 14 }}>몇 가지만 누르면 레이아웃·텍스트·그래프 뼈대를 만들어드려요. 세부는 직접 다듬으면 돼요.</p>
